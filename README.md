...
| Field Name         | Type   | Description |
| ------------------ | ------ | ----------- |
| standard_name      | string | Should be a non-empty value from the [CF Standard Name Table](https://cfconventions.org/Data/cf-standard-names/current/build/cf-standard-name-table.html). This is a required field unless a variable does not have a standard_name in the CF conventions. In this case the long_name is a required field. |
...
| Field Name        | Type     | Description |
| ----------------- | -------- | ----------- |
| standard_name     | string   | As per [CF Object](#CF-object) definition above. |
